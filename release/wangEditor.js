...
Image.prototype = {
    ...
    _createEditPanel: function _createEditPanel() {
        ...
        // 滑动调整图片大小变量
        var widthRange = getRandom('widthRange');
        ...
        var tabsConfig = [{
            ...
            events: [{
                ...
                fn: function fn() {
                    var $img = editor._selectedImg;
                    if ($img) {
                        var $rangeValue = $('#' + widthRange);
                        var width = $rangeValue.val().trim();
